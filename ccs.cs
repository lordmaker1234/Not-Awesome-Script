    ...
    public class Script {
        ...
        public class Uses {
            ...
            public static readonly string[] Documentation = new string[] {
                ...
                "-   using "+ZONE_LABELS,
                "        Allows zones to trigger labels in your script.",
                "        For example, if you have a zone named \"#myLabel\", it will trigger the label \"#myLabel\" in your script.",
                "        Multiple zones can trigger the same label, e.g. \"#myLabel\" and \"second#myLabel\" can both trigger \"#myLabel\".",
                "        You can specify runArgs within a zone name by using a pipe character, \"#myLabel|arg1|arg2\".",
                "",
                "\"include\" statement:",
                "-   include [scriptname]",
